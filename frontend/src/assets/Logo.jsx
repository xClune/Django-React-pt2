  ...
  return (
    <>
        <svg viewBox="0 0 120 87" fill="none" xmlns="http://www.w3.org/2000/svg" className='group'>
            <g id="Frame 2" >
                <g id="Outer Group" className='fill-stone-100'>
                ...
                <g id="Arrow Group" className='group-hover:-translate-y-8 transition-all ease-out duration-700 fill-stone-100 group-hover:fill-stone-700'>
